#include "ddx/motions/moveToPoint.hpp"
#include "LemLog/logger/Helper.hpp"
#include "ddx/MotionCancelHelper.hpp"
#include "ddx/Timer.hpp"
#include "ddx/util.hpp"
...
void moveToPoint(V2Position target, Time timeout, MoveToPointParams params, MoveToPointSettings settings) {
    ...
    ddx::MotionCancelHelper helper(10_msec); // cancel helper
